...
function brush() {
  canvas.style.cursor = "url('.img/brush.png')";
  brush = true;
...
function rectangle() {
  canvas.style.cursor = "url('.img/rectangle.png')";
...
function circle() {
  canvas.style.cursor = "url('.img/circle.png')";
  if (eventcircle == true) {
    eventcircle = false;
  } else {
    eventcircle = true;
...
function ellipses() {
  canvas.style.cursor = "url('.img/oval.png')";
...
const erase = () => {
  canvas.style.cursor = "url('.img/eraser.png')";
  if (eventerase == true) {
    eventerase = false;
  } else {
    eventerase = true;
